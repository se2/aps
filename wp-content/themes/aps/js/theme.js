$(document).ready(function() {
  ...
  $(".load-wait").addClass("hide");
	...
	$(".panel-title a").click(function(e) {
		e.preventDefault();
		var panelContent = $(this).attr('href');
		$(panelContent).toggleClass('in');
	});
...
(function(b) {
  ...
  b.fn.matchHeight._apply = function(a, d) {
    ...
    b.fn.matchHeight._maintainScroll &&
      b(window).scrollTop((e / h) * b("html").outerHeight(!0));
    return this;
  };
        ...
        touch: function() {
          ...
          function i() {
            if (
              ...
              n.animatingTo === n.currentSlide && !y && null !== h)
            ) {
              var e = u ? -h : h,
    ...
    if ("" == a.value) {
      if ("password" == a.type) {
        if (!o.data("placeholder-textinput")) {
          ...
          e
            .removeAttr("name")
            .data({ "placeholder-password": !0, "placeholder-id": d })
  ...
  n && i
    ...
    : ((c = h.placeholder = function() {
      ...
      (d = {
        get: function(e) {
          var a = t(e);
          return a.data("placeholder-enabled") && a.hasClass("placeholder")
            ? ""
            : e.value;
        },
        set: function(e, l) {
          var d = t(e);
          return d.data("placeholder-enabled")
            ? ("" == l
