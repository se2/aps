...
/**
 * Factory for viewmodels of custom fields groups terms, for the purposes of the Custom Fields page, Terms tab.
 *
 * @since 2.3
 */
class Types_Viewmodel_Field_Group_Term_Factory extends Types_Viewmodel_Field_Group_Factory {
	...
	protected function get_field_group_class_name() {
		return 'Types_Viewmodel_Field_Group_Term';
	}
	...
	public static function load( $field_group ) {
		$factory = Types_Viewmodel_Field_Group_Term_Factory::get_instance();
