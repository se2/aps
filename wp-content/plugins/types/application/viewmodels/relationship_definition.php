...
class Types_Viewmodel_Relationship_Definition {
	...
	public function to_array() {
		...
		$data = array(
			...
			'roleLabelsSingular' => $this->relationship->get_role_labels_singular(),
			'roleLabelsPlural' => $this->relationship->get_role_labels_plural(),
	...
	private function get_post_type_disabled_names() {
		$types = array_merge( $this->relationship->get_parent_type()->get_types(), $this->relationship->get_child_type()->get_types() );
