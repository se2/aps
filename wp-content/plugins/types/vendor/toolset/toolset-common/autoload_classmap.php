...
'Toolset_Blocks_CRED_Form' => dirname( __FILE__ ) . '/toolset-blocks/blocks/cred-form/cred-form.php',
...
'Toolset_Elementor_View_Widget_Controls' => dirname( __FILE__ ) . '/toolset-page-builder-modules/modules/elementor/widgets/view/controls.php',
'Toolset_Elementor_View_Widget' => dirname( __FILE__ ) . '/toolset-page-builder-modules/modules/elementor/widgets/view/view.php',
...
'Toolset_Page_Builder_Modules' => dirname( __FILE__ ) . '/toolset-page-builder-modules/toolset-page-builder-modules.php',
'Toolset_Page_Builder_Modules_Elementor' => dirname( __FILE__ ) . '/toolset-page-builder-modules/modules/elementor/elementor.php',
'Toolset_Page_Builder_Modules_Factory' => dirname( __FILE__ ) . '/toolset-page-builder-modules/modules/factory.php',
