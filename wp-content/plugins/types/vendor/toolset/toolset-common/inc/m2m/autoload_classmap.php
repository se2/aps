...
'Toolset_Association_Query_Cache' => dirname( __FILE__ ) . '/association/query/cache.php',
...
'Toolset_Association_Query_Condition_Multiple_Elements' => dirname( __FILE__ ) . '/association/query/condition/multiple_elements.php',
...
'Toolset_Potential_Association_Query_Filter_Posts_Status' => dirname( __FILE__ ) . '/potential_association/filters/post/status.php',
