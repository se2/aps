        ...
        <tr>
            <td colspan="1" rowspan="1">
                <label for="btn1">
                    ...
                    <img alt="" id="btn1-img" src="//www.skypeassets.com/i/legacy/images/share/buttons/call_green_white_153x63.png" height="63" width="153" />
                </label>
            </td>
            <td colspan="1" rowspan="1"> 
                <label for="btn2"> 
                    <input <?php if ( $data['button_style'] == 'btn2' ) echo 'checked="checked" '; ?>id="btn2" name="button_style" tabindex="3" value="btn2" type="radio" />  
                    <img alt="" id="btn2-img" src="//www.skypeassets.com/i/legacy/images/share/buttons/call_blue_white_124x52.png" height="52" width="125" />
                </label> 
            </td>
        </tr>
        <tr>
            <td colspan="1" rowspan="1"> 
                <label for="btn3"> 
                    ...
                    <img alt="" id="btn3-img" src="//www.skypeassets.com/i/legacy/images/share/buttons/call_green_white_92x82.png" height="82" width="92" />
                </label> 
            </td>
            <td colspan="1" rowspan="1"> 
                <label for="btn4"> 
                    <input <?php if ( $data['button_style'] == 'btn4' ) echo 'checked="checked" '; ?>id="btn4" name="button_style" tabindex="5" value="btn4" type="radio" />  
                    <img alt="" id="btn4-img" src="//www.skypeassets.com/i/legacy/images/share/buttons/call_blue_transparent_34x34.png" height="34" width="34" />
                </label> 
            </td>
        </tr>
    </tbody>
        ...
        <tr>
            <td colspan="1" rowspan="1"> 
                <label for="btn5"> 
                    ...
                    <img alt="" id="btn5-img" src="//www.skypeassets.com/i/legacy/images/share/buttons/anim_balloon.gif" height="60" width="150" />
                </label> 
            </td>
            <td colspan="1" rowspan="1"> 
                <label for="btn6"> 
                    <input <?php if ( $data['button_style'] == 'btn6' ) echo 'checked="checked" '; ?>id="btn6" name="button_style" tabindex="7" value="btn6" type="radio" />  
                    <img alt="" id="btn6-img" src="//www.skypeassets.com/i/legacy/images/share/buttons/anim_rectangle.gif" height="44" width="182" />
                </label> 
            </td>
        </tr>
    </tbody>
