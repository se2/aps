				...
				switch( $rfg_action ) {
					...
					case 'start':
						...
						if( ! empty( $presave_slug ) ) {
							...
							$old_definition = $this->service_field_group->delete_relationship_of_group(
								$field_group_object,
								$presave_slug
							);
						}
						...
						if( isset( $old_definition ) && $old_definition && $old_definition->get_row_id() != $new_definition->get_row_id() ) {
