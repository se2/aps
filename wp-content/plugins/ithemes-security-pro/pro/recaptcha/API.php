...
class ITSEC_Recaptcha_API {
	...
	public static function render( array $args ) {
		...
		return self::$recaptcha->get_recaptcha( $args['margin']['top'], $args['margin']['right'], $args['margin']['bottom'], $args['margin']['left'] );
	}
	...
	public static function validate() {
		return self::is_available() && self::$recaptcha->validate_captcha();
	}
}